...
Assert-Release ($version -match '#define HALO_CST_FIRMWARE_VERSION "1\.1\.0-israel-rc2"') "firmware version is 1.1.0-israel-rc2"
...
Assert-Release ($readme -match 'firmware-1\.1\.0--israel--rc2-101820') "README displays the 1.1.0-israel-rc2 version"
