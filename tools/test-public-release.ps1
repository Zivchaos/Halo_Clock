...
$israeliReleaseNotes = Read-Repo "docs/releases/israeli-red-alert-v1.1.0.md"
...
Assert-Release ($version -match '#define HALO_CST_FIRMWARE_VERSION "1\.1\.0-israel"') "firmware version is 1.1.0-israel"
...
Assert-Release ($readme -match 'firmware-1\.1\.0--israel-101820') "README displays the 1.1.0-israel version"
Assert-Release ($israeliReleaseNotes -match '48 hours with Red Alert manually enabled') "stable Israeli release notes record the soak validation"
