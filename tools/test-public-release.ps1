...
Assert-Release ($webService -match 'HALO_CST_PRODUCT_NAME') "Web UI uses centralized product branding"
Assert-Release ($webService -match 'firmwareVersion') "Web UI displays firmware version"
