...
Assert-Release ($version -match '#define HALO_CST_FIRMWARE_VERSION "1\.1\.0-israel-rc1"') "firmware version is 1.1.0-israel-rc1"
...
Assert-Release ($readme -match 'firmware-1\.1\.0--israel--rc1-101820') "README displays the 1.1.0-israel-rc1 version"
