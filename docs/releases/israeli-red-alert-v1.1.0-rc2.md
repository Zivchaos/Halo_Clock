# HALO CST Israeli Red Alert v1.1.0-rc2

This prerelease supersedes the empty `rc1` prerelease. It packages HALO CST's
optional Israeli Red Alert companion on the dedicated Israeli Red Alert branch.
It is a local visual aid only, not an official warning system. Always follow
the official Home Front Command app, sirens, and instructions first.
...
GitHub builds the exact tagged source and attaches
`halo-cst-israeli-red-alert-israeli-red-alert-v1.1.0-rc2.bin` before publishing
this prerelease.
