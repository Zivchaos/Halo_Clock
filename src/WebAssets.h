...
<meta name="theme-color" content="#0b0d18"><title>HALO Clock</title>
<style>
...
<header class="top"><img class="brand" src="/logo.svg" alt="HALO"><div><h1>HALO</h1><div class="tag">Connected Timepiece</div></div><div class="live"><span class="dot"></span>Live</div></header>
<section class="grid">
...
</section><div class="footer">HALO Clock · Elegant. Modular. Connected.</div></main><div class="toast" id="toast"></div>
<script>
